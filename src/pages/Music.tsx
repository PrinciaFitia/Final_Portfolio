      ...
      <div className="container mx-auto px-12">
        ...
        <div className="flex flex-col gap-16 max-w-[840px] mx-auto">
          {projects.map((project, idx) => (
            ...
            >
              <h3 className="font-display italic text-[clamp(30px,4vw,44px)] text-ink font-bold mb-2.5 tracking-tight reveal-text">
          ...
          <motion.div
            ...
            className="pt-8"
          >
            <h3 className="font-display italic text-[clamp(30px,4vw,44px)] text-ink font-bold mb-2.5 tracking-tight">
