...
const timelineItems = [
  ...
  },
  {
    ...
    title: "MamaJazz",
    text: { fr: "Invitée par Linley Marthe — dernier bassiste en titre de Joe Zawinul.", en: "Invited by Linley Marthe — last official bassist of Joe Zawinul." },
              ...
              >
                ...
                <div className="pl-5">
                  <div className={`bg-white border p-6.5 transition-all duration-400 group hover:translate-x-2.5 hover:shadow-xl ${
                    ...
                    <h3 className="font-display italic text-lg text-ink-2 mb-2 font-normal">
                    ...
                    <p className="mt-2.5 text-[12px] text-amber-2/60 italic tracking-wide">
                      {item.names}
                    </p>
                    {item.future && (
                      <a
